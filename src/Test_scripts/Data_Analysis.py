...
def data_analysis():
    ...
    train_df.to_csv(DATA_PATH+'processed_data/test_processed_train_data.csv', index=False)
    test_df.to_csv(DATA_PATH+'processed_data/test_processed_test_data.csv', index=False)
